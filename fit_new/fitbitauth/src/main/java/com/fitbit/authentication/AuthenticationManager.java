...
public class AuthenticationManager {
    ...
    public static void logout(final Context contextActivity) {
        logout(contextActivity, null);
    }

    public static void logout(final Context contextActivity, @Nullable final LogoutTaskCompletionHandler logoutTaskCompletionHandler) {
        checkPreconditions();
        if (!isLoggedIn()) {
            return;
        }
