...
import com.fs.fitbitstreamr.FlyApplication;
...
//    }
    ...
    public static int dip2px(float dipValue) {
        float scale = FlyApplication.getsInstance().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        float fontScale = FlyApplication.getsInstance().getResources().getDisplayMetrics().scaledDensity;
