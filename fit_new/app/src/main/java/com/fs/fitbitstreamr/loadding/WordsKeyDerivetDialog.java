...
public class WordsKeyDerivetDialog extends Dialog implements View.OnClickListener {
    ...
    public WordsKeyDerivetDialog(@NonNull Context context) {
        super(context);
    }

    public WordsKeyDerivetDialog(@NonNull Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_derive_private_words);
