package com.fs.fitbitstreamr.loadding;
...
public class PrivateStoreDerivetDialog extends Dialog implements View.OnClickListener {
    ...
    public PrivateStoreDerivetDialog(@NonNull Context context) {
        super(context);
    }

    public PrivateStoreDerivetDialog(@NonNull Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_derive_private_store);
